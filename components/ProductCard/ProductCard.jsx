    ...
    <div className="h-[500px] border bg-gray-50 relative rounded">
      ...
      <div className="p-[10px] grid grid-flow-row gap-2">
        ...
        <div className="flex gap-2">
          <p className={`${product.discount_price>0?'text-gray-500 line-through':'text-gray-800 font-semibold'}`}>{product.price} Tk</p>
          {
            product.discount_price>0 && (
              <p className="text-gray-800 font-semibold">{product.price-product.discount_price} Tk</p>
            )
          }
        </div>
