  ...
  return (
    <div className="h-[550px] border bg-gray-50 relative">
      ...
      <div className="p-[10px] grid grid-flow-row gap-2">
        <h1 className="font-semibold text-gray-600">{product.title}</h1>
        <div className="flex">
          <svg
        ...
        <div className="grid grid-flow-col grid-cols-6 transition-all duration-900">
          <Link href={`/product-detail/${encodeURIComponent(product.id)}`}>
            <div className="group flex items-center">
              <div className="w-[35px] h-[35px] flex justify-center items-center rounded-[50%] border border-secondary transition-all duration-500 group-hover:bg-secondary">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="20"
                ...
                >
                  <path
                    ...
                    className="fill-secondary transition-all duration-500 group-hover:fill-white"
                  ></path>
                </svg>
              </div>
            </div>
          ...
          <div
            className="w-[35px] h-[35px] flex justify-center items-center border border-secondary rounded-[50%] cursor-pointer"
