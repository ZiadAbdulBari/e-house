...
const Checkout = () => {
          ...
          {newAddress == false && (
            <div className="grid grid-cols-1 gap-2 w-full">
              {addresses.map((address) => (
                <div
                  className="border p-[10px] bg-gray-50 w-full"
                  key={address.id}
                >
  ...
  const renderPaymentStep = () => {
    return (
      <div className="w-[100%] flex flex-col justify-center items-center payment">
        <p className="my-4 font-medium text-[22px] text-color-1">
          Payment Method
        </p>
        <div className="mt-4">
          ...
          >
            ...
            <label htmlFor="payment-1" className="text-[18px] text-gray-800">
              Cash on delivery
            </label>
          </div>
          <div
          ...
          >
            ...
            >
              <svg
                ...
                height="20"
                className={`${
                  selectedPayment == "stripe" ? "fill-color-3" : "fill-color-1"
                }`}
              >
            ...
            <label htmlFor="payment-2" className="text-[18px] text-gray-800">
              Master/Visa
            </label>
          </div>
        </div>
  ...
  const renderOrderStep = () => {
    return (
      <div className="w-[100%] px-[30px] h-full">
        <p className="my-4 font-medium text-[22px] text-color-1">Products</p>
              ...
              return (
                ...
                >
                  ...
                  <div className="w-[55%]">
                    ...
                    <p className="text-gray-800">Size: {product.variants}</p>
                  </div>
                  <div className="w-[10%]">
                    <p className="text-gray-800">{product.cart_quantity} x</p>
                  </div>
                  <div className="w-[20%]">
                    <p
  ...
  return (
    <MainLayout>
      <div className="lg:container mx-auto">
        <div className="flex gap-4 w-full flex-col lg:flex-row h-[100vh]">
          {/* shipping */}
          <div className="w-[30%] px-[30px] h-full hidden lg:block">
            <div className="flex justify-between items-center">
              <p className="my-4 font-medium text-[22px] text-color-1">
                Shipping address
              </p>
          ...
          {/* payment */}
          <div className="w-[20%] payment hidden lg:block">
            <p className="my-4 font-medium text-[22px] text-color-1">
              Payment Method
            </p>
            <div className="mt-4">
          ...
          {/* order */}
          <div className="w-[50%] px-[30px] h-full hidden lg:block">
            <p className="my-4 font-medium text-[22px] text-color-1">
              Products
            </p>
            <div className="h-[55%] overflow-y-auto">
          ...
          <div className="w-full lg:hidden mb-4 lg:mb-0">
            {renderStepContent()}
            <div className="flex justify-evenly mt-8 lg:hidden">
              {step > 1 && (
                <UiButton
                  buttonName="Previous"
